...
class TalentsControllerTest < ActionController::TestCase
  ...
  test "should create talent" do
    assert_difference('Talent.count') do
      post :create, talent: { description: @talent.description, email: @talent.email, name: @talent.name, skill: @talent.skill }
    end
  ...
  test "should update talent" do
    patch :update, id: @talent, talent: { description: @talent.description, email: @talent.email, name: @talent.name, skill: @talent.skill }
    assert_redirected_to talent_path(assigns(:talent))
  end
